...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Inference script — Early Fusion branch")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "False: lazy mmap — each tensor is read on demand "
            "(use when total size exceeds available RAM)."
        ),
    )
    parser.add_argument(
